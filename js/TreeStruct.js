...
function Tree(){
    ...
    this.buildInitTree = function(){
      ...
      this.root.children = this.nodes.filter(node => ["Wine_Cellar","Saloon","Dining_Hall", "Kitchen", "Elevator"].includes(node.name));
